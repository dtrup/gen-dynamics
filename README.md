...
- Use [`research/HOLIDAY_RUNBOOK.md`](research/HOLIDAY_RUNBOOK.md) for the one-minute cloud start/check routine.
- Read [`AGENTS.md`](AGENTS.md) before starting any research run.
